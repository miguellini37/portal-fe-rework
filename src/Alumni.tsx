        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow-lg">
            <form id="post-form" onSubmit={() => {}}>
              <textarea id="post-content" className="form-textarea mb-4 resize-none" rows={3} placeholder="Share your latest achievement or update..." required></textarea>
              <div className="flex justify-end">
                <button type="submit" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">Post</button>
              </div>
            </form>
          </div>
          {/* Community Feed --> */}
