...
export const AccountDeniedBanner: React.FC = () => {
  ...
  const isUnverifiedAccount = !isOrgVerified;
  const isVerifiedStudentUnverifiedSchool =
    permission === USER_PERMISSIONS.ATHLETE && isOrgVerified && isSchoolVerified === false;
  ...
  if (isVerifiedStudentUnverifiedSchool) {
    message =
      'Your school has not yet been verified by Portal. Some features such as NIL opportunities may not be available until your school is verified.';
