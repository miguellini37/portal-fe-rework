      ...
      <div className="Homepage">      
        <div className="hero-section">
          <div className="hero-content">
            ...
            <p className="text-xl text-gray-300 mb-6 hero-text">Connecting NCAA student-athletes with top employers and NIL opportunities.</p>
            <div className="space-x-4">
              <button className="bg-blue-600 text-white px-6 py-3 rounded hover:bg-blue-700" onClick={() => {}}>Join Now (Athletes)</button>
              <button className="bg-gray-700 text-white px-6 py-3 rounded hover:bg-gray-600">Hire Talent (Employers)</button>
            </div>
          </div>
        </div>
