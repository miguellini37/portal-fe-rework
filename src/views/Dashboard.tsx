      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="feed-card bg-gray-800 p-6 rounded-lg">
              ...
              <p>
                <span className="font-semibold">Location:</span> Chicago, IL
              </p>
              <p>
                <span className="font-semibold">Salary Range:</span> $50,000–$65,000
              </p>
              <button
                className="mt-4 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
                onClick={() => {}}
            ...
            <div className="feed-card bg-gray-800 p-6 rounded-lg">
              ...
              <p>
                <span className="font-semibold">Salary Range:</span> $60,000–$75,000
              </p>
              <button
                className="mt-4 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
                onClick={() => {}}
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="feed-card bg-gray-800 p-6 rounded-lg">
              ...
              <p>
                <span className="font-semibold">Compensation:</span> $2,500 + 8-week internship
              </p>
              <button
                className="mt-4 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
                onClick={() => {}}
        ...
        <div>
          ...
          <div id="recent-activity" className="feed-card bg-gray-800 p-6 rounded-lg">
            ...
            <p>
              <span className="font-semibold">Completed:</span> Mastery Logistics Systems, Supply
              Chain Intern – August 2024
            </p>
            <p>
              <span className="font-semibold">Profile Updated:</span> Added internship details –
              April 20, 2025
            </p>
          </div>
        </div>
